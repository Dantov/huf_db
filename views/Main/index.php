		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12">
					<div class="btn-group pull-right" role="group" aria-label="...">
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li role="presentation"><a href="controllers/setSort.php?wcSort=none">Нет</a></li>
                                ...
                                <?php foreach ( $workingCenters as $wcKey => $workingCenter ): ?>
                                    <?php
                                        ...
                                        $wcIDs = trim($wcIDs,'-');
                                    ?>
                                    <li role="presentation"><a href="controllers/setSort.php?wcSort=<?=$wcIDs?>"><?=$wcKey?></a></li>
                                <?php endforeach;?>
                            </ul>
                        </div>
                        <?php endif;?>
						...
						<div class="btn-group" role="group">
							<button type="button" class="btn btn-default dropdown-toggle" title="<?=$chevTitle;?>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							  <span style="font-size:9px;"><span class="glyphicon glyphicon-<?=$chevron_;?>"></span></span>
							</button>
							<ul class="dropdown-menu dropdown-menu-right">
							  <li><a href="controllers/setSort.php?sortDirect=1" title="По возростанию"><span class="glyphicon glyphicon-triangle-top"></span> По возростанию</a></li>
							  <li><a href="controllers/setSort.php?sortDirect=2" title="По убыванию"><span class="glyphicon glyphicon-triangle-bottom"></span> По убыванию</a></li>
							</ul>
						</div>
						...
						<div class="btn-group" role="group">
							...
							<ul class="dropdown-menu dropdown-menu-right">
							  <li><a href="controllers/setSort.php?reg=date">По Дате</a></li>
							  <li><a href="controllers/setSort.php?reg=number_3d">По №3D</a></li>
							  <li><a href="controllers/setSort.php?reg=vendor_code">По Артикулу</a></li>
							  <li><a href="controllers/setSort.php?reg=status">По Статусу</a></li>
							</ul>
						</div>
						...
						<div class="btn-group" role="group">
							...
							<ul class="dropdown-menu dropdown-menu-right">
							  <li><a href="controllers/setSort.php?maxPos=12">12</a></li>
							  <li><a href="controllers/setSort.php?maxPos=18">18</a></li>
							  <li><a href="controllers/setSort.php?maxPos=24">24</a></li>
							  <li><a href="controllers/setSort.php?maxPos=48">48</a></li>
							  <li><a href="controllers/setSort.php?maxPos=102">102</a></li>
							</ul>
						</div>
						
						<div class="btn-group" role="group" aria-label="...">
							<a type="button" href="controllers/setSort.php?row_pos=2" class="btn btn-default <?=$activeList;?>"><span class="glyphicon glyphicon-th-list" title="Разбить по комплектам"></span></a>
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li><a href="controllers/setSort.php?row_pos=3"><span class="glyphicon glyphicon-tasks"></span> Отобразить в таблице Рабочих Участков</a></li>
                                <li><a href="controllers/setSort.php?row_pos=4"><span class="glyphicon glyphicon-menu-hamburger"></span> Отобразить по Рабочим Центрам</a></li>
                            </ul>
                        </div>
						...
						<div class="btn-group <?=$toggleSelectedGroup;?>" id="selectedGroup" role="group">
							...
							<ul class="dropdown-menu dropdown-menu-right">
								<li role="presentation"><a href="controllers/selectionController.php?selectedModels=show">Показать</a></li>
                                <li role="presentation"><a href="../Edit">Проставить статус</a></li>
								<li role="presentation" class="divider"></li>
								<?=$selectedModelsByLi;?>
							</ul>
						</div>
						<div class="btn-group" role="group" aria-label="...">
							<a type="button" id="selectMode" onclick="selects.toggleSelectionMode(this);" class="btn btn-default <?=$variables['activeSelect'];?>"><span class="glyphicon glyphicon-edit" title="Режим выделения"></span></a>
						</div>
					</div>
					...
					<!-- Блок коллекций -->
					<div id="collection_block" coll_block class="">
					...
					<div class="pull-left">
						<h3 style="margin: 0 0 0 15px; padding-top:4px;">
							<a type="button" title="" href="controllers/setSort.php?coll_show=<?=$_SESSION['assist']['collection_id'];?>">
